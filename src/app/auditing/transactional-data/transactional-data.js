      ...
      <div className="flex gap-2 mb-8 items-center py-4">
        ...
        <div className="relative">
          ...
          {filters.operation === "" ?
            ...
            :
            <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500">
              <X className="h-4 w-4 text-muted-foreground" onClick={(e) => handleFilterChange("operation", "")} />
            </span>
          }
        </div>
        <div className="relative">
          ...
          {filters.module === "" ?
            ...
            :
            <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500">
              <X className="h-4 w-4 text-muted-foreground" onClick={(e) => handleFilterChange("module", "")} />
            </span>
          }
        </div>
        <DropdownMenu>
